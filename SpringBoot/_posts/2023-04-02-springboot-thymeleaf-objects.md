...
# [Spring Boot] #8 화면 구성을 위한 Thymeleaf 사용 - 2
...
![image](https://user-images.githubusercontent.com/99089584/229339785-55466b2f-c523-43ed-80ba-1e002c5d0e50.png) <br>
...
### 2) `layout1.html`을 사용하기 위한 `exTemplate.html` 생성
...
## 4. 부트스트랩 템플릿 적용
[부트스트랩 템플릿](https://startbootstrap.com/templates)
